...
// ISO 3166-1 alpha-2 country codes (trimmed of territories rarely used in onboarding can be added later)
export const COUNTRIES: CountryOption[] = [
  ...
  { code: 'KI', name: 'Kiribati' }, { code: 'KR', name: 'Korea (Republic of)' }, { code: 'KW', name: 'Kuwait' },
  ...
  { code: 'GB', name: 'United Kingdom' }, { code: 'US', name: 'United States of America' }, { code: 'UY', name: 'Uruguay' },
...
export const findCountryName = (code?: string) => COUNTRIES.find(c => c.code === code)?.name || '';
